...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/risk-scoring', [RiskController::class, 'index'])->name('risk.index');
    Route::get('/weather-monitoring', [WeatherController::class, 'index'])->name('weather.index');
    Route::get('/currency-impact', [CurrencyController::class, 'index'])->name('currency.index');
    ...
    Route::get('/country-comparison', [ComparisonController::class, 'index'])->name('comparison.index');
    Route::get('/favorite-monitoring', [WatchlistController::class, 'index'])->name('watchlist.index');
